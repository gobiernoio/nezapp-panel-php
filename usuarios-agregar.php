      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <?php } else { 
              ...
              //$consulta = "insert into nezapp_usuarios values ('', '$nombre', '$clave', '$email', '$directorio', '$fecha_registro', '$fecha_ultimo_acceso', '$permiso_usuarios', '$permiso_vial', '$permiso_noticias', '$permiso_agenda', '$permiso_notificaciones', '$permiso_chats_ver', '$permiso_chats_responder', '$permiso_canales', '$observaciones')";
              $consulta = "INSERT INTO nezapp_usuarios VALUES('1', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '')";
